public class Ejer25_2 extends Base{
    public static void main(String[] args) {
        int[] height ={0, 0, 0, 0};
        int[] height_order = {0, 0, 0, 0};
        int temporary = 0;
    ...
    if(height_order[2]>height_order[3]){
        temporary=height_order[2];
        height_order[2]=height_order[3];
        height_order[3]=temporary;
    }
    if(height_order[0]>height_order[1]){
        temporary=height_order[0];
        height_order[0]=height_order[1];
    ...
    screen.println("El orden ascendente es primero: " + height_order[0] +" segundo: " + height_order[1] + " tercero: " + height_order[2] + " cuarto: " + height_order[3]);
    }
