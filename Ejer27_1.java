public class Ejer27_1 extends Base{
    ...
    public static void main(String[] args) {
        ...
        if((birt_day_int>=120 && birt_day_int<=131) || (birt_day_int>=201 && birt_day_int<=218))
            zodiac_sign="Acuario";
        else if((birt_day_int>=219 && birt_day_int<=228) || (birt_day_int>=301 && birt_day_int<=320))
            zodiac_sign="Picis";
        else if((birt_day_int>=321 && birt_day_int<=331) || (birt_day_int>=401 && birt_day_int <=419))
            zodiac_sign="Aries";
        ...
        if((birt_day_int>=622 && birt_day_int<=630) || (birt_day_int>=701 && birt_day_int<=722))
            ...
            {zodiac_sign="Leo";}
        else if ((birt_day_int>=823 && birt_day_int<=831) || (birt_day_int>=901 && birt_day_int<=922))
            {zodiac_sign="Virgo";}
        else if((birt_day_int>=923 && birt_day_int<= 930) || (birt_day_int>=1001 && birt_day_int<=1022))
            zodiac_sign="Libra";
        else if((birt_day_int>=1023 && birt_day_int<=1031) || (birt_day_int>=1101 && birt_day_int<=1121))
            zodiac_sign="Escorpio";
        else if((birt_day_int>=1122 && birt_day_int<=1130) || (birt_day_int>=1201 && birt_day_int<=1221))
            zodiac_sign="Sagitario";
        else if((birt_day_int>=1222 && birt_day_int<=1231) || (birt_day_int>=101 && birt_day_int<=119))
